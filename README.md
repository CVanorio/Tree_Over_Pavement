...
| -------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **NAIP (USDA)**                        | 1-m four-band imagery (RGB + NIR) used as model input                | [https://developers.google.com/earth-engine/datasets/catalog/USDA_NAIP_DOQQ](https://developers.google.com/earth-engine/datasets/catalog/USDA_NAIP_DOQQ)                         |
| **OpenStreetMap (OSM)**                | Roads, sidewalks, cycleways, parking areas used to build paved masks | [https://www.openstreetmap.org](https://www.openstreetmap.org)                                                                                                                   |
| **Meta High-Resolution Canopy Height** | 1-m canopy height used to detect tree presence                       | [https://developers.google.com/earth-engine/datasets/catalog/Meta_Highres_Canopy_Height](https://developers.google.com/earth-engine/datasets/catalog/Meta_Highres_Canopy_Height) |
